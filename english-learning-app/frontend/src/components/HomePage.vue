<template>
    <div class="split-layout" :class="{ 'dark-mode': userStore.theme === 'dark' }">
...
/* 🌑 暗夜模式 - 左侧 */
.split-layout.dark-mode .left-panel {
    background-color: #1a202c; /* 强制深色 */
}
...
/* 🌑 暗夜模式 - 右侧 */
.split-layout.dark-mode .right-panel {
    background-color: #1a202c; /* 强制深色，确保和左侧一致，解决不联动问题 */
    /* 确保没有 border-left */
    border-left: none; 
}
...
/* 🌑 暗夜模式 - Tab item */
.split-layout.dark-mode .tab-item {
    color: #a0aec0;
}
...
.split-layout.dark-mode .tab-item.active {
    color: #ed8936;
}
...
/* 🌑 暗夜模式 - 卡片 */
.split-layout.dark-mode .my-rank-card {
    background-color: #2d3748; /* 强制深色卡片 */
    border-color: #4a5568;
    box-shadow: none;
}
...
.split-layout.dark-mode .my-rank-info h3,
.split-layout.dark-mode .my-rank-info .group-welcome {
    color: #e2e8f0;
}

.split-layout.dark-mode .my-rank-info .group-slogan {
    color: #a0aec0;
}
...
.split-layout.dark-mode .my-rank-info p {
    color: #a0aec0;
}
...
.split-layout.dark-mode .monster-avatar {
...
/* 🌑 暗夜模式 - 列表项 */
.split-layout.dark-mode .rank-item {
    background-color: #2d3748; /* 强制深色 */
    border-color: #4a5568;
    color: #e2e8f0;
}
...
.split-layout.dark-mode .empty-state {
    color: #a0aec0;
}
...
.split-layout.dark-mode .rank-name {
    color: #e2e8f0;
}
...
.split-layout.dark-mode .rank-score {
    color: #a0aec0;
}
...
/* 暗夜模式适配 */
.split-layout.dark-mode .site-footer a {
    color: #718096;
}
